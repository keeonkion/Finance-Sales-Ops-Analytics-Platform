...
--------------------------------------------------------
-- 1. Add surrogate primary keys on fact tables
--------------------------------------------------------

-- FactSales
ALTER TABLE factsales
    ADD COLUMN factsalesid BIGSERIAL PRIMARY KEY;

-- FactSalesTarget
ALTER TABLE factsalestarget
    ADD COLUMN factsalestargetid BIGSERIAL PRIMARY KEY;

-- FactOrders
ALTER TABLE factorders
    ADD COLUMN factordersid BIGSERIAL PRIMARY KEY;

-- FactInventory
ALTER TABLE factinventory
    ADD COLUMN factinventoryid BIGSERIAL PRIMARY KEY;

-- FactProduction
ALTER TABLE factproduction
    ADD COLUMN factproductionid BIGSERIAL PRIMARY KEY;

-- Finance PL
ALTER TABLE factfinancepl
    ADD COLUMN factfinanceplid BIGSERIAL PRIMARY KEY;

-- Finance BS
ALTER TABLE factfinancebs
    ADD COLUMN factfinancebsid BIGSERIAL PRIMARY KEY;

-- Finance CF
ALTER TABLE factfinancecf
    ADD COLUMN factfinancecfid BIGSERIAL PRIMARY KEY;
