...
sql = """
select *
from analytics.ml_train_inventory_monthly
order by country_name, region_name, ds;
"""
...
run_name = "inventory_linear_regression_baseline"
...
with mlflow.start_run(run_name=run_name):
    ...
    # -------------------------------------------------
    out = df_test[["ds", "country_name", "region_name"]].copy()
    ...
    # 7) Artifacts
    # -------------------------------------------------
    pred_path = "inventory_predictions.csv"
    out.to_csv(pred_path, index=False)
    mlflow.log_artifact(pred_path)

    feat_path = "inventory_features.json"
